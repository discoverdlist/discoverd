                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 mt-4 relative">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
                        ...
                        <div id="dropdownDefault" data-dropdown-content className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg mt-2 shadow w-44 absolute top-full left-0 dark:bg-gray-700">
                            <ul>
                                ...
                                <li>
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Configurações</a>
                                </li>
                                <li>
                                    <a href="/bots/add" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Adicionar bot</a>
                                </li>
                                <li>
                                    <a href="#" onClick={() => signOut()} className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Sair</a>
                                </li>
                            </ul>
                        </div>
                        <Script id="dropdown">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:border-gray-700">
                            <li>
                                <a href="#" className="md:text-white block py-2 px-3 text-white rounded md:hover:bg-transparent md:p-0 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Início</a>
                            </li>
                            <li>
                                <a href="#" className="md:text-white block py-2 px-3 text-white rounded md:hover:bg-transparent md:p-0 md:dark:hover:bg-transparent dark:border-gray-700">Explorar</a>
                            </li>
                            <li>
                                <a href="#" className="md:text-white block py-2 px-3 text-white rounded md:hover:bg-transparent md:p-0 md:dark:hover:bg-transparent dark:border-gray-700">Parceiros</a>
                            </li>
                        </ul>
                    </div>
                </div>
