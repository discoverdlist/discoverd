...
import { Clock, ThumbsUp, Server, Bot, Search, ArrowLeft } from "lucide-react";
import { useTranslation } from "../../../hooks/useTranslation";

export default function NewBotsPage() {
  ...
  const fetchBots = useCallback(async () => {
    try {
      setIsLoading(true);
      const response = await fetch(`/api/bots?filter=newest&limit=24`);
          ...
          <div className="flex items-center mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {t("newBots.addedOn")} {formatDate(bot.createdAt)}
              </p>
            </div>
          </div>
